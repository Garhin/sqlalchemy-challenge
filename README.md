...
On a long holiday vacation in Honolulu, Hawaii! As part of planing a trip, climate analysis on the area is very importanat. 

## Step 1 - Climate Analysis and Exploration

By using a Python and SQLAlchemy to do basic climate analysis and data exploration of the climate database. All of the following analysis will be completed using SQLAlchemy ORM queries, Pandas, and Matplotlib.
